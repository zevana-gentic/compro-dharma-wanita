            ...
            <div class="collapse navbar-collapse" id="navbarSupportedContent">
                ...
                <ul class="navbar-nav me-auto mb-2 mb-lg-0">
                    ...
                    <li class="nav-item dropdown">
                        ...
                        <ul class="dropdown-menu">
                            <li>
                                <a class="dropdown-item" href="#">DWP Sekretariat Daerah</a>
                            </li>
                            <li><a class="dropdown-item" href="#">DWP Inspektorat</a></li>
                            <li>
                                <a class="dropdown-item" href="#">DWP Dinas Pendidikan</a>
                            </li>
                    ...
                    <li class="nav-item dropdown">
                        ...
                        <ul class="dropdown-menu">
                            <li>
                                <a class="dropdown-item" href="#">Bidang Pendidikan</a>
                            </li>
                            <li>
                                <a class="dropdown-item" href="#">Bidang Sosial Budaya</a>
                            </li>
                            <li><a class="dropdown-item" href="#">Bidang Ekonomi</a></li>
                        </ul>
                    </li>
                    <li class="nav-item">
