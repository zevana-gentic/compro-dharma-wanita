    ...
    <div class="container">
        <div class="justify-content-between align-items-center flex-wrap grid-margin">
            <div>
                ...
                <div class="row mt-3">
                    <div class="col-md-2">
                        <a href="{{ route('sekda.news.add') }}" class="btn btn-primary btn-md" title="Tambah Berita">
                        ...
                        <tbody>
                            @forelse ($news as $item)
                                <tr>
                                    ...
                                    <td>
                                        <a class="btn btn-success btn-icon btn-edit mr-2" href="{{ route('sekda.news.edit', $item->id) }}"><i data-feather="edit"></i></a>
...
@section('js')
    <script>
        $('.btn-hapus').on('click', function() {
            ...
            $('.form-delete').attr('action', '{{ url('sekda') }}/news-delete/'+id);
        });
    </script>
@endsection
