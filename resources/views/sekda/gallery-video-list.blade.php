...
<div class="page-content">
    <div class="container">
        <div class="justify-content-between align-items-center flex-wrap grid-margin">
            ...
            <div class="row mt-3">
                <div class="col-md-3">
                    <a href="{{ route('sekda.gallery.video.add') }}" class="btn btn-primary btn-md" title="Tambah Berita">
                        ...
                        <tbody>
                            @forelse ($videos as $item)
                                <tr>
                                    ...
                                    <td>
                                        <a class="btn btn-success btn-icon btn-edit mr-2" href="{{ route('sekda.gallery.video.edit', $item->id) }}"><i data-feather="edit"></i></a>
...
@section('js')
    <script>
        $('.btn-hapus').on('click', function() {
            ...
            $('.form-delete').attr('action', '{{ url('sekda') }}/video-delete/'+id);
        });
    </script>
@endsection
