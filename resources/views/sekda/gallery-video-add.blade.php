...
@section('content')
    <div class="page-content">
        <div class="container">
            ...
            <div class="card">
                <div class="card-body">
                    <form action="{{ route('sekda.gallery.video.submit') }}" method="POST" enctype="multipart/form-data">
                        @csrf
                        <div class="mb-3">
                            ...
                            <textarea class="form-control" name="video" cols="30" rows="10" placeholder="Contoh: https://www.youtube.com/embed.....">{{ old('video') }}</textarea>
                            @error('video')
                                <small class="text-danger">{{ $message }}</small>
                            @enderror
                        </div>
                        <div class="d-flex justify-content-end">
                            <a href="{{ route('sekda.gallery.video.list') }}" class="btn btn-secondary mr-2">Kembali</a>
