            ...
            <div class="body berita-content">
                <div class="row">
                    @foreach ($news as $item)
                        <div class="col-md-3">
                            <div class="card my-3">
                                <img src="{{ asset('uploads/'. $item->image_thumbnail) }}" class="img-thumbnail" alt="" />
                                <div class="card-body">
                                    <div class="title-body">{{ $item->title }} Lorem ipsum dolor sit amet consectetur adipisicing elit. Mollitia, eligendi.</div>
